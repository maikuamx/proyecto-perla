...
export default function ProductGrid({ filters, limit, featured }: ProductGridProps) {
  ...
  if (featured) {
    // For featured products, randomly select 6 products
    displayProducts = products
      ?.sort(() => 0.5 - Math.random())
      .slice(0, limit || 6)
  } else {
    // For catalog, use pagination
  ...
  return (
    <>
      ...
      {/* Pagination - Only show in catalog, not for featured products */}
      {!featured && products && products.length > itemsPerPage && (
